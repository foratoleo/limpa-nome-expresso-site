...
### Documentos Pessoais
- [ ] RG (frente e verso) — digitalizado em PDF
- [ ] CPF — digitalizado em PDF
...
### Prova do Dano Atual (O Gatilho da Urgência)
- [ ] Documento **datado de 2026** comprovando o prejuízo causado pela negativação. Exemplos:
  - E-mail de banco negando crédito, cartão ou financiamento
  - Proposta de emprego condicionada a "nome limpo" (print de WhatsApp ou e-mail)
  - Negativa de crediário em loja (nota de recusa)
  - Negativa de aluguel de imóvel
  - **Quanto mais recente e específico, melhor**

---

## PASSO 2 — PETIÇÃO INICIAL

- [ ] Baixar o modelo: **peticao_inicial_jec_sp.md** (disponível neste site)
- [ ] Preencher todos os campos marcados com `[PREENCHER: ...]`
- [ ] Revisar a seção "DOS FATOS" — descrever o prejuízo com detalhes
- [ ] Confirmar que o pedido de exclusão está "até o trânsito em julgado"
- [ ] Confirmar que a multa diária de R$ 500,00 está incluída
- [ ] Listar todos os documentos na seção "DOCUMENTOS ANEXOS"
- [ ] Salvar em **PDF** (máx. 30 MB por arquivo, 300 KB por página)
...
- [ ] Finalizar e **anotar o número do processo gerado**
...
- [ ] Acessar o Balcão Virtual imediatamente após o protocolo
- [ ] Selecionar: **1ª Instância — Juizados Especiais**
- [ ] Selecionar o foro onde o processo foi distribuído
- [ ] Aguardar na fila e usar o roteiro de fala ao ser atendido
- [ ] Anotar o nome do servidor e o protocolo do atendimento
