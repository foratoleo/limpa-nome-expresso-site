...
export function AuthModal({
  ...
  return (
    ...
    >
      <div
        className="flex min-h-dvh items-start justify-center p-3 sm:items-center sm:p-4"
        onClick={handleBackdropClick}
      >
        <div
          className={`w-full rounded-2xl border p-4 sm:p-6 ${isRegisterTab ? "max-w-5xl" : "max-w-md"} max-h-[calc(100dvh-1.5rem)] overflow-y-auto`}
          style={{
        ...
        >
          ...
          {tab === "register" && (
            <div className="grid gap-4 lg:gap-6 lg:grid-cols-[1.2fr_1fr]">
              <aside
                className="order-2 rounded-2xl border p-5 lg:order-1 lg:p-6"
                style={{
                  background:
              ...
              >
                ...
                <h3 className="text-xl lg:text-2xl font-bold leading-tight mb-4" style={{ color: "#f1f5f9" }}>
              ...
              <div
                className="order-1 rounded-2xl border p-5 sm:p-6 lg:order-2"
                style={{
