...
export const STEPS: Step[] = [
  {
    ...
    items: [
      ...
      { id: "relatorio_credito", label: "Relatório completo de restrições do CPF", detail: "Documento atualizado mostrando a restrição que você contesta" },
      { id: "print_email_entrada", label: "Print da caixa de entrada do e-mail", detail: "Busque por 'notificação', 'restrição' e o nome da empresa credora" },
      ...
      { id: "print_sms", label: "Print do histórico de SMS do celular", detail: "Mostrando ausência de mensagens da empresa ou do cadastro de crédito" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "verificar_multa", label: "Confirmar a multa diária de R$ 500,00 (astreintes)", detail: "Força o cumprimento da ordem judicial em 5 dias úteis" },
      ...
      { id: "salvar_pdf", label: "Salvar a petição preenchida em formato PDF", detail: "Max. 30 MB por arquivo, 300 KB por página - exigência do sistema judicial" },
    ],
  },
  {
    number: 3,
    title: "Protocolo no Sistema Judicial",
    subtitle: "Fluxo Oficial para o JEC",
    ...
    links: [
      { label: "Abrir Modelos de Protocolo", url: "/modelos", external: false },
      { label: "Orientações de Protocolo", url: "/suporte", external: false },
    ],
    items: [
      { id: "acessar_esaj", label: "Acessar o sistema de peticionamento do tribunal", detail: "Use o portal de protocolo eletrônico da sua comarca" },
      ...
      { id: "iniciar_processo", label: "Iniciar novo processo e preencher os campos obrigatórios", detail: "Competência: JEC | Classe: 436 | Assunto: restrição de crédito indevida" },
      { id: "cadastrar_partes", label: "Cadastrar as partes: você (Autor) + empresa credora + entidade de cadastro (Réus)", detail: "Inclua a entidade mantenedora do cadastro quando aplicável" },
      { id: "marcar_urgencia", label: "Marcar a opção 'Pedido Liminar / Tutela Antecipada'", detail: "Campo para prioridade na análise - só marque se houver dano irreparável" },
  ...
  },
  {
    ...
    links: [
      { label: "Abrir roteiro de atendimento", url: "/downloads", external: false },
    ],
    downloads: [
    ...
    items: [
      ...
      { id: "acessar_balcao", label: "Acessar o balcão virtual do tribunal (Seg-Sex, 9h-17h)", detail: "Selecionar: 1ª Instância - Juizados Especiais" },
  ...
  },
  {
    ...
    color: "#22c55e",
    tip: "Liminar concedida: o cadastro de crédito tem 5 dias úteis para cumprir após a intimação. Verifique seu nome após esse prazo.",
    links: [
      { label: "Consultar andamento interno", url: "/processo", external: false },
      { label: "Revisar checklist da fase", url: "/guia", external: false },
    ],
    items: [
      { id: "monitorar_diario", label: "Monitorar o processo diariamente no sistema do tribunal", detail: "Acompanhe com o número do processo até atualização da decisão" },
      { id: "liminar_concedida", label: "Se liminar concedida: aguardar 5 dias úteis para a exclusão", detail: "O cartório intimará a entidade de cadastro, que terá esse prazo para cumprir" },
      { id: "verificar_nome", label: "Verificar o nome no cadastro de crédito após o prazo", detail: "Confirme se a restrição foi removida após a intimação" },
      ...
      { id: "multa_descumprimento", label: "Se houver descumprimento: acionar a multa diária (astreintes)", detail: "Petição no sistema judicial informando o descumprimento e solicitando a aplicação da multa de R$ 500/dia" },
    ],
  },
];
