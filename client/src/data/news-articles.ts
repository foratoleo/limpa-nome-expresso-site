...
export const NEWS_ARTICLES: NewsArticle[] = [
  ...
  },
  {
    ...
    publishedDate: "2026-03-07",
    estimatedReadTime: 4,
    tags: ["estatísticas", "inadimplência", "Serasa", "endividamento"],
  ...
  },
  {
    ...
    title: "Score Serasa e Negativação Indevida: Como a Injustiça Afeta Seu Crédito",
    metaDescription:
      "Uma negativação indevida derruba seu score Serasa e fecha portas de crédito. Entenda como funciona a pontuação e por que a exclusão judicial é urgente.",
    keywords: [
      "score Serasa negativação indevida",
      "como negativação afeta score",
      "score baixo por negativação",
      "Serasa score indevido",
    ...
    publishedDate: "2026-03-07",
    estimatedReadTime: 4,
    tags: ["score", "Serasa", "crédito", "pontuação"],
    category: "score",
    contentFile: "/docs/noticias/score-serasa-negativacao-indevida.md",
  },
  {
    id: "9",
