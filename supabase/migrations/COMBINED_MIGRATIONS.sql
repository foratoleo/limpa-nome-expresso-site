-- ============================================================================
-- COMBINED MIGRATIONS: 007, 008, 010
...
CREATE POLICY IF NOT EXISTS "Users can read own access"
...
CREATE POLICY IF NOT EXISTS "Service role has full access to admin_audit_log"
  ON admin_audit_log
  FOR ALL
  TO service_role
  USING (true)
...
SELECT 'user_access table' as table_name, COUNT(*) as columns
FROM information_schema.columns
WHERE table_name = 'user_access';

SELECT 'admin_audit_log table' as table_name, COUNT(*) as columns
FROM information_schema.columns
...
-- 2. Go to: https://supabase.com/dashboard/project/dtbrzojuopcyfgmaybzt/sql/new
